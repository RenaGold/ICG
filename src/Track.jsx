...
export function Track() {
  ...
  return (
    ...
    <ColliderBox position={[3.855, 0, -0.9]} scale={[0.3, 1, 10]}/>
    <ColliderBox position={[-8.45, 0, -0.9]} scale={[0.3, 1, 10]}/>
    <ColliderBox position={[-2.3, 0, 4.25]} scale={[12.6, 1, 0.3]}/>
    <ColliderBox position={[-2.3, 0, -6.05]} scale={[12.6, 1, 0.3]}/>
